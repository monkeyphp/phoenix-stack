...
# @link https://www.npmjs.com/package/elm                                     #
###############################################################################
echo -e '\E[0;35m'"\033[1m Attempting to install Elm-Lang using NPM \033[0m"
npm install -g elm
if [ $? -ne 0 ];
    then
        echo -e '\E[0;41m'"\033[1m Could not install Elm-Lang \033[0m"
        exit $?
fi
echo -e '\E[1;32m'"\033[1m Successfully Installed Elm-Lang \033[0m"
